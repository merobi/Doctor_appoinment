              ...
              <tbody>
                <tr>
					...
					<td>
						...
						<a href="edit-doctors.php"><button type="button" class="btn btn-primary">Edit</button></a>
				...
				<tr>
					...
					<td>61</td>                              
					<td>
						<a href="doctors_profile_details.php"><button type="button" class="btn btn-info">View</button></a>
						<a href="edit-doctors.php"><button type="button" class="btn btn-primary">Edit</button></a></a>
						<a href="" onClick="return confirm('Are you sure want to delete?');" title="Delete"><button type="submit" class="btn btn-danger">Delete</button></a>
					</td>
                </tr>  				
              </tbody>
