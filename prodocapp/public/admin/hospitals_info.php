          ...
          <div class="white-box">
            ...
            <div class="table-responsive">
             <table id="myTable" class="table table-striped">
              ...
              <tbody>
                <tr>
					<td><img src="imgs/shelby-diagnostic-center.jpg" style="height:70px;width:70px"></td>
					...
					<td>
						...
						<a href="edit_hospital.php"><button type="button" class="btn btn-primary">Edit</button></a>
				...
				<tr>
					...
					<td>
						...
						<a href="edit_hospital.php"><button type="button" class="btn btn-primary">Edit</button></a></a>
						<a href="" onClick="return confirm('Are you sure want to delete?');" title="Delete"><a href="" onClick="return confirm('Are you sure want to delete?');" title="Delete"><button type="submit" class="btn btn-danger">Delete</button></a></a>
					</td>
                </tr>  				
              </tbody>
            </table>
