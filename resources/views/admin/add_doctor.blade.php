            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    ...
                    <div class="row" style="background:#fff">
                         {!! Form::open(array('url' => 'add_doctor_cheek' , 'method'=>'post', 'files'=>'true','enctype'=>'multipart/form-data' )) !!}
                            <div class="col-sm-6">
                                <div class="white-box">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="birthday" id="datepicker-autoclose" placeholder="mm/dd/yyyy" required>
                                            <div class="help-block with-errors"></div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="regi_no" placeholder="Enter Registration Number"  required>
                                            <div class="help-block with-errors"></div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="email" class="form-control" name="email" placeholder="Enter Registration Number"  required>
                                            <div class="help-block with-errors"></div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="phone_no" placeholder="Enter Registration Number"  required>
                                            <div class="help-block with-errors"></div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="post_code" placeholder="Enter Registration Number"  required>
                                            <div class="help-block with-errors"></div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <select class="selectpicker m-b-0 m-r-10" id="country" name="country_name" style="width:100%" data-style="btn-primary btn-outline" required>
                      ...
                      <?php } ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <select class="selectpicker m-b-0 m-r-10" id="city" name="c_city" style="width:100%" data-style="btn-primary btn-outline" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea type="email" class="form-control" name="about_me"  placeholder="Enter About Doctor"  required></textarea>
                                            <div class="help-block with-errors"></div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-sm-6">
                                <div class="white-box">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="c_name" placeholder="Enter Chamber Name" required>
                                            <div class="help-block with-errors"></div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="inputEmail4" class="control-label col-sm-3">Address</label>
                                        <div class="col-sm-9">
                                            <textarea type="email" class="form-control" name="c_address"  placeholder="Enter Address"  required></textarea>
                                            <div class="help-block with-errors"></div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="inputEmail4" class="control-label col-sm-3">Post Code</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="c_code" placeholder="Enter Post Code"  required>
                                            <div class="help-block with-errors"></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label for="inputName4" class="control-label col-sm-3">Country</label>
                                        <div class="col-sm-9">
                                            <select class="selectpicker m-b-0 m-r-10" id="country1" name="country_id2" style="width:100%" data-style="btn-primary btn-outline" required>
                                                <option value="">Select Country</option>
                                                               <?php foreach ($country_list as $key) { ?>
                         <option value="{{$key->country_id}}">{{$key->country_name}}</option>
                      <?php } ?>
                                    ...
                                    <div class="form-group">
                                        <label for="inputName4" class="control-label col-sm-3">City</label>
                                        <div class="col-sm-9">
                                            <select class="selectpicker m-b-0 m-r-10" id="city1" name="city_id" style="width:100%" data-style="btn-primary btn-outline" required>
                                                <option value="">Select City</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="c_phone" placeholder="Enter Contact Number" required>
                                            <div class="help-block with-errors"></div>
                                        </div>        
                                    </div>
                                    <div class="form-group">                
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="c_suppt" placeholder="Enter Support Number" required>
                                            <div class="help-block with-errors"></div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="c_date" id="datepicker" placeholder="mm/dd/yyyy" required>
                                            <div class="help-block with-errors"></div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">                
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="start_time" placeholder="Enter Start time" required>
                                            <div class="help-block with-errors"></div>
                                        </div>
                                    </div>
                                    <div class="form-group">                
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="end_time" placeholder="Enter End Time" required>
                                            <div class="help-block with-errors"></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="subspeciality" placeholder="Enter Sub-Speciality "  required>
                                            <div class="help-block with-errors"></div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="institution" placeholder="Enter Institution  "  required>
                                            <div class="help-block with-errors"></div>
                                        </div>
                                    </div>
                                   ...
                                   <!-- <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="username" id="inputName4" placeholder="Cina Saffary" required>
                                            <div class="help-block with-errors"></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="password" data-toggle="validator" name="password" data-minlength="6" class="form-control" id="inputPassword4" placeholder="Password" required>
