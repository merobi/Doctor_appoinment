  ...
  <div id="page-wrapper">
    <div class="container-fluid">
      ...
      <div class="row" style="background:#fff">    
       {!! Form::open(array('url' => 'update_diagnostic' , 'method'=>'post', 'files'=>'true','enctype'=>'multipart/form-data')) !!}
     <div data-toggle="validator" class="form-horizontal">
      ...
      <div class="col-sm-6">
         ...
         <h3 class="box-title m-b-0" style="text-align:center">Diagnostic Center Information</h3>
           ...
           <?php foreach ($diagnostic_details as $diagnostic_details) { ?>
              <div class="form-group">
                <label for="inputName4" class="control-label col-sm-3">Diagnostic Center Name</label>
                 <div class="col-sm-9">
                <input type="text" class="form-control" name="name" value="{{ $diagnostic_details->name }}" placeholder="Enter Diagnostic Center Name"  required>
                 <input type="hidden" class="form-control" name="user_id" value="{{ $diagnostic_details->id }}" placeholder="Enter Diagnostic Center Name"  required>
                  <div class="help-block with-errors"></div>
                </div>
              </div>
              <div class="form-group">
                <label for="inputName4" class="control-label col-sm-3">Diagnostic Center Image</label>
                 <div class="col-sm-9">
        ...
        <div class="form-group">
                <label for="inputName4" class="control-label col-sm-3">Registration Code</label>
                 <div class="col-sm-9">
          <input type="text" class="form-control"  value="{{ $diagnostic_details->registration }}" name="registration_code" placeholder="Enter Post Code"  required>
                  <div class="help-block with-errors"></div>
                </div>
              </div>
        <div class="form-group">
                <label for="inputName4" class="control-label col-sm-3">Post Code</label>
                 <div class="col-sm-9">
          <input type="text" class="form-control"  value="{{ $diagnostic_details->post_code }}" name="post_code" placeholder="Enter Post Code"  required>
                  <div class="help-block with-errors"></div>
                </div>
              </div>
              <!--<div class="form-group">
        ...
        <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input type="email" class="form-control"  value="{{ $diagnostic_details->email }}" name="email" placeholder="Enter Email"  required>
                  <div class="help-block with-errors"></div>
                </div>
              </div>
        <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input type="text" class="form-control"  value="{{ $diagnostic_details->phone }}" name="phone" placeholder="Enter Phone Number"  required>
                  <div class="help-block with-errors"></div>
                </div>
              </div>
        <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input type="text" class="form-control"  value="{{ $diagnostic_details->fax }}" name="fax" placeholder="Enter Phone Number"  required>
                  <div class="help-block with-errors"></div>
                </div>
              </div>
...
$country_list = DB::table('tbl_country')
    ...
    <div class="col-sm-6">
          <div class="white-box">
            ...
            <p class="text-muted m-b-30">  </p>
               ...
               <div class="form-group">
                ...
                <div class="col-sm-9">
                  <textarea type="text" class="form-control"  name="address" placeholder="Enter Address"  required>{{ $diagnostic_details->address }}</textarea>
                  <div class="help-block with-errors"></div>
                </div>
              </div>
        <div class="form-group">
                ...
                <div class="col-sm-9">
                  <textarea type="text" class="form-control"   name="about_hospital" placeholder="Enter Address"  required>{{ $diagnostic_details->about_hospital }}</textarea>
                  <div class="help-block with-errors"></div>
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-sm-9">
                    <select disabled class="selectpicker m-b-0 m-r-10" style="width:100%" id="country" name="country_id" data-style="btn-primary btn-outline" required>
                      <?php foreach ($country_details as $country_details) { ?>
                      <option value="{{ $country_details->country_id }}">{{ $country_details->country_name}}</option>
                       <?php } ?>
          ...
          <div class="help-block with-errors"></div>
               ...
               <div class="form-group">
                ...
                <div class="col-sm-9">
                    <select disabled class="selectpicker m-b-0 m-r-10" style="width:100%" id="city" name="city_id" data-style="btn-primary btn-outline" required>
                      <?php foreach ($city_details as $city_details) { ?>
                      <option value="{{ $city_details->city_id}}">{{ $city_details->city_name}}</option>
                       <?php } ?>
       ...
       <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input type="text" class="form-control" value="{{ $users->username }}" id="inputName4" name="username" placeholder="Enter Username" required>
                  <div class="help-block with-errors"></div>
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input type="password" data-toggle="validator" value="{{ $users->password }}" data-minlength="6" name="password" class="form-control" id="inputPassword4" placeholder="Password" required>
