    ...
    <div class="container-fluid">
      <div class="row bg-title">
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
          <h4 class="page-title">Export Diagnostic center</h4>
        </div>
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
          <ol class="breadcrumb">
            <li><a href="#">Dashboard</a></li>
            <li><a href="#"> Diagnostic center</a></li>
            <li class="active">Export Diagnostic center</li>
          </ol>
        </div>
        <!-- /.col-lg-12 -->
      </div>
      ...
      <div class="row" style="background:#fff">
	   <form data-toggle="validator" class="form-horizontal">
			...
			<div class="col-sm-6">
			  <div class="white-box">
				<h3 class="box-title m-b-0" style="text-align:center">Export Diagnostic center Information</h3>
				<p class="text-muted m-b-30">  </p>
				
				<div class="form-group">
                <div class="col-sm-9 col-sm-offset-5">
                   <a href="export_diagnostic_download"><button type="button" class="btn btn-info">Export</button></a>
                </div>
              </div>
			  </div>
			</div>
