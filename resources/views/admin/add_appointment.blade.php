...
<div id="wrapper">
  ...
  <div id="page-wrapper">
    <div class="container-fluid">
	  ...
	  {!! Form::open(array('url' => 'manage_appointment' , 'method'=>'post', 'files'=>'true' )) !!}
     <div data-toggle="validator" class="form-horizontal" >
		...
		<div class="col-sm-6">
          <div class="white-box">
			  ...
			  <h3 class="box-title m-b-0" style="text-align:center">Set Appointment</h3>
              <p class="text-muted m-b-30" style="color:green;text-align:center"><?php echo Session::get('message'); ?></p>  
           
              <div class="form-group">
                <label for="inputName4" class="control-label col-sm-3">Select Patient</label>
                  <div class="col-sm-9">
                    <select class="selectpicker m-b-0 m-r-10" name="patient_id" style="width:100%" data-style="btn-primary btn-outline" required>
            						<option value="">Select Patient</option>
            						<?php foreach ($patients_info as $row) { ?>                          
              ...
              <div class="form-group">
                <label for="inputName4" class="control-label col-sm-3">Select Doctor</label>
                  <div class="col-sm-9">
                    <select class="selectpicker m-b-0 m-r-10" name="doctor_id" style="width:100%" data-style="btn-primary btn-outline" required>
                        <option value="">Select Doctor</option>
                       <?php foreach ($doctors_info as $row) { ?>                          
              ...
              <div class="form-group">
                <label for="inputName4" class="control-label col-sm-3">Select Chamber</label>
                  <div class="col-sm-9">
                    <select class="selectpicker m-b-0 m-r-10" name="chamber_id"  style="width:100%" data-style="btn-primary btn-outline" required>
                        <option value="">Select Chamber</option>
                        <?php foreach ($camber_info as $row) { ?>                          
                          <option value="{{ $row->id }}">{{ $row->name }}</option>
                        <?php } ?>
                    </select>
                    <div class="help-block with-errors"></div>
              ...
              <div class="form-group">
                <label for="inputEmail4" class="control-label col-sm-3">Select Date</label>
                <div class="col-sm-9">
                    <input type="text" class="form-control" name="date" id="datepicker-autoclose" placeholder="mm/dd/yyyy" required>
                   <div class="help-block with-errors"></div>
                </div>
              </div>
              <div class="form-group">
                <label for="inputEmail4" class="control-label col-sm-3" >Select Day</label>
                <div class="col-sm-9">
                     <select class="selectpicker m-b-0 m-r-10" name="app_day" style="width:100%" data-style="btn-primary btn-outline" required>
              ...
              <div class="form-group">
                <label for="inputEmail4" class="control-label col-sm-3" >Select Time</label>
                <div class="col-sm-9">
                     <select class="selectpicker m-b-0 m-r-10" name="app_time" style="width:100%" data-style="btn-primary btn-outline" required>
            						<option value="">Select Time</option>
            						<?php foreach ($camber_info as $row) { ?>                          
                          <option value="{{ $row->start_time.' - '.$row->end_time }}">{{ $row->start_time.' - '.$row->end_time }}</option>
                        <?php } ?>
          					 </select>
				        	   <div class="help-block with-errors"></div>
                </div>
