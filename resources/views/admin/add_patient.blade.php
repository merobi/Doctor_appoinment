  ...
  <div id="page-wrapper">
    <div class="container-fluid">
      ...
      <div class="row" style="background:#fff">
	    <form data-toggle="validator" class="form-horizontal" method="POST" action="manage_patient" enctype="multipart/form-data">
          ...
          <div class="white-box">
            ...
            <p class="text-muted m-b-30">  </p>
              ...
              <div class="form-group">
                <label for="inputEmail4" class="control-label col-sm-3">Name</label>
                <div class="col-sm-9">
               ...
               <div class="form-group">
                ...
                <div class="col-sm-9">
                  ...
                  <div class="help-block with-errors"></div>
			       ...
			       <div class="form-group">
                <label for="inputEmail4" class="control-label col-sm-3">Age</label>
                <div class="col-sm-9">
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                <label for="inputEmail4" class="control-label col-sm-3">Gender</label>
                <div class="col-sm-9">
                    <input type="text" class="form-control" name="gender" placeholder="Enter Registration Number"  required>
					<div class="help-block with-errors"></div>
                </div>
              </div>
               <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" name="email" placeholder="Enter Registration Number"  required>
          <div class="help-block with-errors"></div>
                </div>
              </div>
               <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" name="phone" placeholder="Enter Registration Number"  required>
          <div class="help-block with-errors"></div>
                </div>
              </div>
		...
		<div class="col-sm-6">
          <div class="white-box">
              ...
              <div class="form-group m-t-30" >
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" name="bloodgroup" placeholder="Enter Registration Number"  required>
          <div class="help-block with-errors"></div>
                </div>
              </div>
         <div class="form-group">
            ...
            <p class="text-muted m-b-30">  </p>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input type="text" class="form-control" id="inputName4" name="username" placeholder="Cina Saffary" required>
                  <div class="help-block with-errors"></div>
                </div>
              </div>
