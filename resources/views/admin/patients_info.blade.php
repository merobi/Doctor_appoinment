        ...
        <div class="col-sm-12">
          <div class="white-box">
            ...
            <p class="text-muted m-b-30" style="color:green;text-align:center"><?php echo Session::get('message'); ?></p>
             <a href="add_patient"><button type="button" class="btn btn-primary">Add New Patient</button></a>
             <br><br>  
              ...
              ?>
                <tr>
                  ...
                  <td>
                    ...
                    <a href="<?php echo 'edit_patient/'.$row->id ?>"><button type="button" class="btn btn-primary"><i class="fa fa-pencil-square-o " aria-hidden="true"></i></button></a>                   
                    <a href="<?php echo 'delete_patient/'.$row->id ?>" onClick="return confirm('Are you sure want to delete?');" title="Delete"><button type="submit" class="btn btn-danger"><i class="fa fa-trash-o " aria-hidden="true"></i></button></a>
                  </td>
                </tr> 
              <?php } ?>
