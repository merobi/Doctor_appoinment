  ...
  <div id="page-wrapper">
    <div class="container-fluid">
      ...
      <div class="row" style="background:#fff">
	   ...
	   <form data-toggle="validator" class="form-horizontal" method="POST" action="manage_admin" enctype="multipart/form-data">
      <div class="col-sm-3">
          ...
          <div class="white-box">
            ...
            <p class="text-muted m-b-30" style="color:green;text-align:center"><?php echo Session::get('message'); ?></p>  
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input type="password" name="password" data-toggle="validator" data-minlength="6" class="form-control" id="inputPassword4" placeholder="Enter Password" required>
               ...
               <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input type="text" class="form-control" id="inputName4" name="fullname" placeholder="Enter Full Name" required>
                  <div class="help-block with-errors"></div>
                </div>
              </div>
               <div class="form-group">
                <label for="inputName4" class="control-label col-sm-3">Photo</label>
                <div class="col-sm-9">
               ...
               <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input type="email" class="form-control" id="inputName4" name="email" placeholder="Enter Email" required>
                  <div class="help-block with-errors"></div>
                </div>
              </div>
               <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input type="number" class="form-control" id="inputName4" name="phone" placeholder="Enter Phone" required>
                  <div class="help-block with-errors"></div>
                </div>
              </div>
               <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input type="text" class="form-control" id="inputName4" name="address" placeholder="Enter Address" required>
                  <div class="help-block with-errors"></div>
                </div>
              </div>
