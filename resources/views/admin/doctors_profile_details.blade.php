            ...
            <table id="myTable" class="table table-striped">
              ...
              <tbody>
                <tr>
					...
					<td>0132465761</td>                              
					<td>
						<a href=""><button type="button" class="btn btn-info"><i class="fa fa-eye fa-2x" aria-hidden="true"></i></button></a>
						<a href="edit_patient"><button type="button" class="btn btn-primary"><i class="fa fa-pencil-square-o fa-2x" aria-hidden="true"></i></button></a>
