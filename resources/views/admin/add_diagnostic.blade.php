...
<div id="wrapper">
  ...
  <div id="page-wrapper">
            ...
            <p class="text-muted m-b-30">  </p>
              ...
              <div class="form-group">
                <label for="inputName4" class="control-label col-sm-3">Diagnostic Center Name</label>
                 <div class="col-sm-9">
          <input type="text" class="form-control" name="name" placeholder="Enter Diagnostic Center Name"  required>
              ...
              <div class="form-group">
                <label for="inputName4" class="control-label col-sm-3">Diagnostic Center Image</label>
                 <div class="col-sm-9">
                     <input type="file"  name="image" placeholder="Enter Diagnostic Center Name"  required>
                  <div class="help-block with-errors"></div>
                </div>
              </div>
        <div class="form-group">
                <label for="inputName4" class="control-label col-sm-3">Registration Code</label>
                 <div class="col-sm-9">
          <input type="text" class="form-control" name="registration_code" placeholder="Enter Registration Code"  required>
                  <div class="help-block with-errors"></div>
                </div>
              </div>
        <div class="form-group">
    ...
    <div class="col-sm-6">
        ...
        <div class="form-group">
                <label for="inputEmail4" class="control-label col-sm-3">About Diagnostic Center</label>
                <div class="col-sm-9">
                  <textarea type="text" class="form-control"  name="about_hospital" placeholder="Enter Diagnostic Center"  required></textarea>
                  <div class="help-block with-errors"></div>
                </div>
              </div>
               <div class="form-group">
                ...
                <div class="col-sm-9">
                    <select class="selectpicker m-b-0 m-r-10" style="width:100%" id="country" name="country_id" data-style="btn-primary btn-outline" required>
          ...
          <div class="help-block with-errors"></div>
               ...
               <div class="form-group">
                ...
                <div class="col-sm-9">
                    <select class="selectpicker m-b-0 m-r-10" style="width:100%" id="city" name="city_id" data-style="btn-primary btn-outline" required>
                      <option value="">Select City</option>
