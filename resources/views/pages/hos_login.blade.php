            ...
            <div class="row">
                <div class="col column offset-l2 s12 m12 l8" style="border:1px solid #9E449B">
                    ...
                    <div class="contact-form">
                        ...
                        {!! Form::open(array('url' => '/Hospital-login' , 'method'=>'post'  )) !!}
                        <div class="row" style="padding:30px">
                            ...
                            <div class="input-field col s12 m12 l12">
                                <a href="{{URL::to('/hospital-registration')}}"><button id="submit" class="coloured-btn submit" type="button"><i class="fa fa-registered" aria-hidden="true"></i> Registration</button></a>
                            </div>
                        </div>
                        {!! Form::close() !!} 
                    </div><!-- Contact Form -->
