...
<div class="pagetop">
    <div class="container">
        {!! Form::open(array('url' => '/All-Center-search'  , 'files'=>'true','method'=>'get' )) !!}
                              <?php
            ...
            <div class="row">
                ...
                <div class="input-field col m3 s12">
                    <select id="center" class="center" name="center">
                        ...
                        <div class="recent-posts">
                            ...
                            foreach ($hospital_info as $v_info) {
                                ...
                                <div class="widget-post">
                                    <div class="widget-post-img"><a href="{{URL::to('/center-profile/'.$v_info->id)}}"><img src="{{URL::to('/')}}<?php echo '/' . $v_info->image; ?>" style="height:150px;width:150px;" alt="" /></a></div>
