...
<div class="pagetop">
    <div class="container">		
        <ul>
            <h1>Registration form (only for Diagnostic Center)</h1>
            ...
            <div class="row">
                <div class="col column  s12 m12 " style="border:1px solid #9E449B">
                    <div class="contact-form">
                        ...
                        {!! Form::open(array('url' => '/Diagnostic-info-save' , 'method'=>'post' , 'files'=>'true' )) !!}
                        ...
                        <div class="row" style="padding:10px">	
                            ...
                            <div class="input-field col s12 m12">
                                <div class="input-field col s12 m2">
                                    <span>About Diagnostic <b style="color:red"> * </b> </span>
                                </div>
                                <div class="input-field col s12 m9">
                                    <input name="about_diagnostic"  type="text" />
                                    <span> </span>
                                </div>									
                            </div>
                        </div>
                        ...
                        <div class="row" style="padding:10px">	
                            ...
                            <div class="input-field col s12 m12">
                                <div class="input-field col s12 m2">
                                    ...
                                    <input type="hidden" name="type" value="Daignostic" class="span6 typeahead" >
                                </div>
                                <div class="input-field col s12 m3">
