...
?>
                        <div class="widget">
                            ...
                            <li style="list-style:none;"><a href="{{URL::to('/help-details/'.$v_info->id)}}">{{$v_info->heading}}</a></li>
                        ...
                        <div class="widget">
                            ...
                            <ul>
                                ...
                                foreach ($link_info as $v_info) {
                                    ?>
                                    <li><a href="{{URL::to('/help-details/'.$v_info->id)}}">{{$v_info->heading}}</a></li>
                                <?php } ?>
                            </ul>						
                        </div><!-- Widget -->	
<!--                        <div class="widget">
    ...
    <div id="profile" class="modal fade" role="dialog">
        <div class="modal-dialog">
            {!! Form::open(array('url' => '/update-center-profile' , 'method'=>'post','name'=>'edit_profile', 'files'=>'true' )) !!}
            <!-- Modal content-->
    ...
    <div id="about" class="modal fade" role="dialog" style="height: 300px;">
        <div class="modal-dialog">
            {!! Form::open(array('url' => '/update-center-about' , 'method'=>'post', 'files'=>'true' )) !!}
            <!-- Modal content-->
            <div class="modal-content">
                <div class="modal-header" style="background-color: rgba(230,230,230,0.9);">
    ...
    <div id="service" class="modal fade" role="dialog" style="height: 350px;">
        <div class="modal-dialog">
            {!! Form::open(array('url' => '/center-medical-service' , 'method'=>'post', 'files'=>'true' )) !!}
            <!-- Modal content-->
            <div class="modal-content">
                <div class="modal-header" style="background-color: rgba(230,230,230,0.9);">

                    <h4 class="modal-title" style="text-align: center;">Add Diagnostic Service</h4>
                </div>
                <div class="modal-body">
                    <div class="row" style="padding:10px">
    ...
    <div id="link" class="modal fade" role="dialog" style="height:250px;">
        <div class="modal-dialog">
            {!! Form::open(array('url' => '/Add-center-help-link' , 'method'=>'post', 'files'=>'true' )) !!}
            <!-- Modal content-->
            <div class="modal-content">
                <div class="modal-header" style="background-color: rgba(230,230,230,0.9);">
    ...
    <div id="media" class="modal fade" role="dialog" style="height: 300px;">
        <div class="modal-dialog">
            {!! Form::open(array('url' => '/update-center-media' , 'method'=>'post', 'files'=>'true' )) !!}
            <!-- Modal content-->
            <div class="modal-content">
                <div class="modal-header" style="background-color: rgba(230,230,230,0.9);">
