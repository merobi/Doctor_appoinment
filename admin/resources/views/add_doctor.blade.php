                            ...
                            <div class="col-sm-6">
                                <div class="white-box">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <select class="selectpicker m-b-0 m-r-10" name="country_name" style="width:100%" data-style="btn-primary btn-outline" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea type="email" class="form-control" name="about_me"  placeholder="Enter Address"  required></textarea>
                                            <div class="help-block with-errors"></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="link" placeholder="Enter Registration Number"  required>
                                            <div class="help-block with-errors"></div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <div class="white-box">
                                    ...
                                    <div class="form-group">
                                        <label for="inputEmail4" class="control-label col-sm-3">Post Code</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="c_code" placeholder="Enter Registration Number"  required>
                                            <div class="help-block with-errors"></div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="inputName4" class="control-label col-sm-3">City</label>
                                        <div class="col-sm-9">
                                            <select class="selectpicker m-b-0 m-r-10" name="city_id" style="width:100%" data-style="btn-primary btn-outline" required>
                                                <option value="">Select City</option>
                                                <option value="1">Dhaka</option>
                                                <option value="2">Gazipur</option>
                                            </select>
                                    ...
                                    <div class="form-group">
                                        <label for="inputName4" class="control-label col-sm-3">Country</label>
                                        <div class="col-sm-9">
                                            <select class="selectpicker m-b-0 m-r-10" name="country_id2" style="width:100%" data-style="btn-primary btn-outline" required>
                                                <option value="">Select Country</option>
                                                <option value="1">Bangladesh</option>
                                                <option value="2">India</option>
                                            </select>
                                    ...
                                    <div class="form-group">                
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="start_time" placeholder="Enter Support Number" required>
                                            <div class="help-block with-errors"></div>
                                        </div>
                                    </div>
                                    <div class="form-group">                
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="end_time" placeholder="Enter Support Number" required>
                                            <div class="help-block with-errors"></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="subspeciality" placeholder="Enter Speciality "  required>
                                            <div class="help-block with-errors"></div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="institution" placeholder="Enter Speciality "  required>
                                            <div class="help-block with-errors"></div>
                                        </div>
                                    </div>
