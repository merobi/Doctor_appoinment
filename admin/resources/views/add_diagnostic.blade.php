    ...
    <div class="col-sm-6">
        ...
        <div class="form-group">
               ...
               <div class="form-group">
                ...
                <div class="col-sm-9">
                    <select class="selectpicker m-b-0 m-r-10" style="width:100%" name="country_id" data-style="btn-primary btn-outline" required>
          ...
          <div class="help-block with-errors"></div>
               ...
               <div class="form-group">
                ...
                <div class="col-sm-9">
                    <select class="selectpicker m-b-0 m-r-10" style="width:100%" name="city_id" data-style="btn-primary btn-outline" required>
                      <option value="">Select City</option>
                      <option value="1">Dhaka</option>
                      <option value="2">Rajsahi.</option>
                   </select>
