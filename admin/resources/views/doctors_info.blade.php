    ...
    <div class="container-fluid">
      <div class="row bg-title">
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
          <h4 class="page-title">Doctors Information</h4>
        </div>
        ...
        <div class="col-sm-12">
          <div class="white-box">
            ...
            <div class="table-responsive">
              ...
              <tbody>
                <tr>
					<td><img src="imgs/57473download.jpg" style="height:70px;width:70px"></td>
					<td>System Architect</td>
					<td>Edinburgh</td>
					<td>61</td>                              
					<td>61</td>                              
					<td>
						<button type="button" class="btn btn-info"><i class="fa fa-eye fa-2x" aria-hidden="true"></i></button>
						<a href="edit-doctors"><button type="button" class="btn btn-primary"><i class="fa fa-pencil-square-o fa-2x" aria-hidden="true"></i></button></a>
						<a href="" onClick="return confirm('Are you sure want to delete?');" title="Delete"><button type="submit" class="btn btn-danger"><i class="fa fa-trash-o fa-2x" aria-hidden="true"></i></button></a>
					</td>
                </tr>  
				<tr>
					<td><img src="imgs/57473download.jpg" style="height:70px;width:70px"></td>
					...
					<td>61</td>                              
					<td>
						<a href="doctors_profile_details"><button type="button" class="btn btn-info"><i class="fa fa-eye fa-2x" aria-hidden="true"></i></button></a>
						<a href="edit-doctors"><button type="button" class="btn btn-primary"><i class="fa fa-pencil-square-o fa-2x" aria-hidden="true"></i></button></a></a>
						<a href="" onClick="return confirm('Are you sure want to delete?');" title="Delete"><button type="submit" class="btn btn-danger"><i class="fa fa-trash-o fa-2x" aria-hidden="true"></i></button></a>
					</td>
                </tr>  				
              </tbody>
