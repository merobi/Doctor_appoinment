  ...
  <nav class="navbar navbar-default navbar-static-top m-b-0">
    <div class="navbar-header"> <a class="navbar-toggle hidden-sm hidden-md hidden-lg " href="javascript:void(0)" data-toggle="collapse" data-target=".navbar-collapse"><i class="ti-menu"></i></a>
     ...
     <?php foreach ($login_user_details as $row) { ?>
        ...
        <li class="dropdown"> <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#"> <img src="plugins/images/users/varun.jpg" alt="user-img" width="36" class="img-circle"><b class="hidden-xs"><?php echo $row->fullname; ?></b> </a>
        ...
        <div class="col-sm-12">
          <div class="white-box">
            ...
            <p class="text-muted m-b-30" style="color:green;text-align:center"><?php echo Session::get('message'); ?></p>
             <a href="add_admin"><button type="button" class="btn btn-primary">Add New Admin</button></a>
             <br><br>  
              ...
              ?>
                <tr>
                  ...
                  <td>
                    ...
                    <a href="<?php echo 'delete_admin/'.$row->id ?>" onClick="return confirm('Are you sure want to delete?');" title="Delete"><button type="submit" class="btn btn-danger"><i class="fa fa-trash-o " aria-hidden="true"></i></button></a>
                  </td>
                </tr> 
              <?php } ?>
