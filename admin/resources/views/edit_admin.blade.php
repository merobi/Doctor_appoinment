  ...
  <div id="page-wrapper">
    <div class="container-fluid">
      ...
      <div class="row" style="background:#fff">    
       {!! Form::open(array('url' => 'update_admin' , 'method'=>'post', 'files'=>'true','enctype'=>'multipart/form-data')) !!}
           ...
           <?php 
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input type="text" value="<?= $row->fullname ?>"  class="form-control" id="inputName4" name="fullname" placeholder="Enter Full Name" required>
                  <div class="help-block with-errors"></div>
                </div>
              </div>
               <div class="form-group">
                ...
                <div class="col-sm-9">
                  <img src="{{ URL::to('/') }}/imgs/{{ $row->image }}" style="height:150px;with:150px" alt="{{ $row->fullname }}" />
                </div>
              </div>
              <div class="form-group">
                <label for="inputName4" class="control-label col-sm-3">Select New Photo</label>
                <div class="col-sm-9">
                  <input type="file"  id="inputName4" name="image" >
                  <div class="help-block with-errors"></div>
                </div>
              </div>
               <div class="form-group">
