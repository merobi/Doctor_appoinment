    ...
    <div class="container-fluid">
      <div class="row bg-title">
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
          <h4 class="page-title">Patients Information</h4>
        </div>
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
          <ol class="breadcrumb">
            <li><a href="#">Dashboard</a></li>
            <li><a href="#">Patients</a></li>
            <li class="active">Patients Information</li>
          </ol>
        </div>
        <!-- /.col-lg-12 -->
      </div>
        ...
        <div class="col-sm-12">
          <div class="white-box">
            ...
            <p class="text-muted m-b-30" style="color:green;text-align:center"><?php echo Session::get('message'); ?></p>
             <a href="add_appointment"><button type="button" class="btn btn-primary">Add New Appointment</button></a>
             <br><br>  
            <table id="myTable" class="table table-striped">
              ...
              ?>
                <tr>
                  ...
                  <td><?php echo $row->chambername; ?> </td> 
                  <td><?php echo $row->app_day; ?> </td>
                  <td><?php echo $row->app_time; ?> </td>         
                  <td>
                    
                    <a href="<?php echo 'edit_admin/'.$row->appid ?>"><button type="button" class="btn btn-primary"><i class="fa fa-pencil-square-o " aria-hidden="true"></i></button></a>                   
                    <a href="<?php echo 'delete_appointment/'.$row->appid ?>" onClick="return confirm('Are you sure want to delete?');" title="Delete"><button type="submit" class="btn btn-danger"><i class="fa fa-trash-o " aria-hidden="true"></i></button></a>
                  </td>
                </tr> 
              <?php } ?>
