...
<section id="wrapper" class="login-register">
  <div class="login-box">
    <div class="white-box">
      <form class="form-horizontal form-material" id="loginform"  action="manage_login" method="POST">
        <h3 class="box-title m-b-20">Sign In</h3>
        <p class="text-muted m-b-30" style="color:red;text-align:center"><?php echo Session::get('message'); ?></p>
